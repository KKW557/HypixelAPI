...
public class HypixelAPI {
    ...
    private String baseUrl = "https://api.hypixel.net/";
     ...
     */
    public CompletableFuture<ResourceReply> getResource(@NotNull ResourceType resource) {
    ...
    private CompletableFuture<ResourceReply> requestResource(String resource) {
        return httpClient.makeRequest(baseUrl + "resources/" + resource)
                .thenApply(this::checkResponse)
    ...
    public UUID getVerifyingKey()
    {
        return this.httpClient.getVerifyingKey();
    }

    public void setVerifyingKey(UUID verifyingKey)
    {
        this.httpClient.setVerifyingKey(verifyingKey);
    }
}
